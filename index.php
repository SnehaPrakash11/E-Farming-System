...
<html lang="en">
	<head>
	    ...
	    <title>AgriBuzz Home Page</title>
...
<div id="hero" class="homepage-slider3">
	<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
		<div class="full-width-slider">	
			<div class="item" style="background-image: url(assets/images/sliders/ban1.jpg);">
				<!-- /.container-fluid -->
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
	    
	    <div class="full-width-slider">
			<div class="item full-width-slider" style="background-image: url(assets/images/sliders/ban2.jpg);">
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
			...
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Featured Products</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					...
					<li><a href="#farmerskit" data-toggle="tab">Farmer's Kit</a></li>
					<li><a href="#farmersmarket" data-toggle="tab">Farmer's Market</a></li>
				</ul><!-- /.nav-tabs -->
			</div>
...
?>
	...
	<div class="tab-pane" id="farmerskit">
					<div class="product-slider">
...
?>
	...
	<?php } ?>
		...
		<div class="tab-pane" id="farmersmarket">
					<div class="product-slider">
						<div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
		<?php
				...
				<div class="row">
					<div class="col-md-6">
	                   <section class="section">
	                   	<h3 class="section-title">Farmer's Kit</h3>
	                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
	   
<?php
$ret=mysqli_query($con,"select * from products where category=3 and subCategory=3");
while ($row=mysqli_fetch_array($ret)) 
{
?>
...
<?php }?>
					...
					<div class="col-md-6">
						<section class="section">
							<h3 class="section-title">Farmer's Market</h3>
		                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
	<?php
